"""
	This is a batch image importer to quickly import images all at once, create or not create layered textures, and
	assign said textures to specified channels.

	It is most likely that you have received an older version of this script or a
	version still in development. Feel free to contact me
